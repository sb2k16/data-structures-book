...
- [5.1 Problem Statement & Motivation](#problem-statement-motivation)
  - [What Problem Do Stacks and Queues Solve?](#what-problem-do-stacks-and-queues-solve)
  - [When to Use Stacks](#when-to-use-stacks)
  - [When to Use Queues](#when-to-use-queues)
  - [When NOT to Use Stacks/Queues](#when-not-to-use-stacksqueues)
- [5.2 Conceptual Overview](#conceptual-overview)
...
- [5.8 Correctness Argument](#correctness-argument)
  ...
  - [Why Queue Enqueue Is Correct](#why-queue-enqueue-is-correct)
  - [Why Queue Dequeue Is Correct](#why-queue-dequeue-is-correct)
- [5.9 Edge Cases & Failure Modes](#edge-cases-failure-modes)
  - [Empty Stack/Queue Operations](#empty-stackqueue-operations)
  - [Full Stack/Queue (Array-Based)](#full-stackqueue-array-based)
  - [Circular Queue Edge Cases](#circular-queue-edge-cases)
  - [Memory Issues](#memory-issues)
- [5.10 Performance & System Considerations ⭐](#performance-system-considerations)
  - [Memory Layout Impact](#memory-layout-impact)
  - [Cache Behavior](#cache-behavior)
  - [When Stacks/Queues Become Bottlenecks](#when-stacksqueues-become-bottlenecks)
...
- [5.13 Common Pitfalls & Interview Traps](#common-pitfalls-interview-traps)
  - [1. Accessing Empty Stack/Queue](#accessing-empty-stackqueue)
  - [2. Stack Overflow](#stack-overflow)
  - [3. Memory Leaks](#memory-leaks)
  - [4. Circular Queue Full/Empty Confusion](#circular-queue-fullempty-confusion)
  - [5. Incorrect Order](#incorrect-order)
  - [5.13.1 Stack Applications](#1-stack-applications)
  - [Expression Evaluation](#expression-evaluation)
  - [Balanced Parentheses Check](#balanced-parentheses-check)
  - [Function Call Stack Simulation](#function-call-stack-simulation)
  - [Backtracking with Stack](#backtracking-with-stack)
  - [5.13.2 Queue Applications](#2-queue-applications)
  - [BFS (Breadth-First Search) Implementation](#bfs-breadth-first-search-implementation)
  - [Task Scheduling Simulation](#task-scheduling-simulation)
  - [Print Level Order (Binary Tree)](#print-level-order-binary-tree)
  - [Buffering with Queue](#buffering-with-queue)
  - [5.13.3 Advanced Stack Problems](#3-advanced-stack-problems)
  - [Min Stack Implementation](#min-stack-implementation)
  - [Max Stack Implementation](#max-stack-implementation)
  - [Advanced Max Stack with popMax() Operation](#advanced-max-stack-with-popmax-operation)
  - [Advanced Min/Max Stack with Additional Operations](#advanced-minmax-stack-with-additional-operations)
  - [Key Insights and Trade-offs](#key-insights-and-trade-offs)
  - [5.13.4 Common Interview Problems](#4-common-interview-problems)
  - [5.9.4 Monotonic Stack and Queue Patterns ⭐ (Important for Interviews)](#4-monotonic-stack-and-queue-patterns-important-for-interviews)
  - [Additional Performance Analysis](#additional-performance-analysis)
  - [Space Complexity](#space-complexity)
- [5.14 Exercises & Thought Questions](#exercises-thought-questions)
  - [Conceptual Questions](#conceptual-questions)
  - [Implementation Tasks](#implementation-tasks)
  - [Performance Reasoning](#performance-reasoning)
  - [Interview-Style Problems](#interview-style-problems)
- [5.15 Key Takeaways](#key-takeaways)
  - [Additional Practice Exercises](#additional-practice-exercises)
- [5.16 Concurrency Considerations](#concurrency-considerations)
  - [5.12.1 Shared-State Invariants](#1-shared-state-invariants)
  - [5.12.2 Operations That Must Be Atomic](#2-operations-that-must-be-atomic)
  - [5.12.3 Naïve Approaches and Why They Fail](#3-naïve-approaches-and-why-they-fail)
  - [5.12.4 Locking Strategies](#4-locking-strategies)
  - [5.12.5 Performance and Scalability Implications](#5-performance-and-scalability-implications)
  - [5.12.6 When Not to Do This Yourself](#6-when-not-to-do-this-yourself)
  - [Additional Failure Modes](#additional-failure-modes)
  - [5.13.1 Common Pitfalls](#1-common-pitfalls)
  - [5.13.2 What Breaks Invariants](#2-what-breaks-invariants)
