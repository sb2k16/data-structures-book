...
- [9.1 Problem Statement & Motivation](#problem-statement-motivation)
  - [What Problem Does Sorting Solve?](#what-problem-does-sorting-solve)
  - [When to Use Sorting](#when-to-use-sorting)
  - [When NOT to Use Sorting](#when-not-to-use-sorting)
- [9.2 Conceptual Overview](#conceptual-overview)
  - [Intuitive Explanation](#intuitive-explanation)
  - [Why Sorting Matters](#why-sorting-matters)
  - [Sorting Criteria](#sorting-criteria)
- [9.3 Abstract Model & Invariants ⭐](#abstract-model-invariants)
  - [Abstract Model](#abstract-model)
  - [Core Invariants](#core-invariants)
  - [How Sorting Preserves Invariants](#how-sorting-preserves-invariants)
- [9.4 Operations & Interface](#operations-interface)
  - [Behavioral Guarantees](#behavioral-guarantees)
- [9.5 Time & Space Complexity](#time-space-complexity)
  - [Comparison-Based Sorting Complexity](#comparison-based-sorting-complexity)
  - [Non-Comparison Sorting Complexity](#non-comparison-sorting-complexity)
- [9.6 Pseudocode (Language-Neutral) ⭐](#pseudocode-language-neutral)
  - [Bubble Sort](#bubble-sort)
  - [Insertion Sort](#insertion-sort)
  - [Merge Sort](#merge-sort)
  - [Quick Sort](#quick-sort)
  - [Heap Sort](#heap-sort)
- [9.7 Implementation (Reference Language: C++) ⭐](#implementation-reference-language-c)
  - [9.7.1 Comparison-Based Sorting Algorithms](#1-comparison-based-sorting-algorithms)
  - [2. Selection Sort](#selection-sort)
  - [3. Insertion Sort](#insertion-sort)
  - [4. Merge Sort](#merge-sort)
  - [5. Quick Sort](#quick-sort)
  - [6. Heap Sort](#heap-sort)
  - [9.7.2 Non-Comparison Sorting Algorithms](#2-non-comparison-sorting-algorithms)
  - [1. Counting Sort](#counting-sort)
  - [2. Radix Sort](#radix-sort)
  - [3. Bucket Sort](#bucket-sort)
  - [9.7.3 Hybrid Sorting Algorithms](#3-hybrid-sorting-algorithms)
  - [Timsort (Used in Python and Java)](#timsort-used-in-python-and-java)
- [9.8 Correctness Argument](#correctness-argument)
  - [Why Merge Sort Is Correct](#why-merge-sort-is-correct)
  - [Why Quick Sort Is Correct](#why-quick-sort-is-correct)
  - [Why Heap Sort Is Correct](#why-heap-sort-is-correct)
- [9.9 Edge Cases & Failure Modes](#edge-cases-failure-modes)
  - [Empty Array](#empty-array)
  - [Single Element Array](#single-element-array)
  - [Already Sorted Array](#already-sorted-array)
  - [All Equal Elements](#all-equal-elements)
  - [Very Large Arrays](#very-large-arrays)
  - [Integer Overflow](#integer-overflow)
- [9.10 Performance & System Considerations ⭐](#performance-system-considerations)
  - [Memory Access Patterns](#memory-access-patterns)
  - [Cache Behavior](#cache-behavior)
  - [When Sorting Becomes Bottleneck](#when-sorting-becomes-bottleneck)
- [9.11 Variants & Extensions](#variants-extensions)
  - [Sorting Variants](#sorting-variants)
  - [Hybrid Algorithms](#hybrid-algorithms)
- [9.12 Real-World Implementations](#real-world-implementations)
  - [C++ Standard Library: std::sort](#c-standard-library-stdsort)
  - [Python: list.sort(), sorted()](#python-listsort-sorted)
  - [Java: Arrays.sort()](#java-arrayssort)
- [9.13 Common Pitfalls & Interview Traps](#common-pitfalls-interview-traps)
  - [1. Assuming O(n log n) Is Always Best](#assuming-on-log-n-is-always-best)
  - [2. Ignoring Stability Requirements](#ignoring-stability-requirements)
  - [3. Quick Sort Worst Case](#quick-sort-worst-case)
  - [4. Integer Overflow in Index Calculation](#integer-overflow-in-index-calculation)
  - [5. Not Handling Empty/Single Element](#not-handling-emptysingle-element)
  - [6. Memory Issues with Merge Sort](#memory-issues-with-merge-sort)
  - [9.5.1 Performance Comparison](#1-performance-comparison)
  - [Time Complexity Summary](#time-complexity-summary)
  - [When to Use Which Algorithm](#when-to-use-which-algorithm)
  - [9.5.2 Testing and Benchmarking](#2-testing-and-benchmarking)
- [9.14 Choosing the Right Sorting Algorithm](#choosing-the-right-sorting-algorithm)
  ...
  - [Sorting Algorithm Decision Tree](#sorting-algorithm-decision-tree)
  - [Additional Practical Considerations](#additional-practical-considerations)
  - [When to Use Each Algorithm](#when-to-use-each-algorithm)
  - [Real-World Performance Tips](#real-world-performance-tips)
  - [Common Mistakes to Avoid](#common-mistakes-to-avoid)
- [9.15 Exercises & Thought Questions](#exercises-thought-questions)
  - [Conceptual Questions](#conceptual-questions)
  - [Implementation Tasks](#implementation-tasks)
  - [Performance Reasoning](#performance-reasoning)
  - [Interview-Style Problems](#interview-style-problems)
- [9.16 Key Takeaways](#key-takeaways)
  - [Additional Exercises](#additional-exercises)
- [9.17 Summary](#summary)
