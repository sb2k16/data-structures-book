...
- [13.1 Problem Statement & Motivation](#problem-statement-motivation)
  - [What Problem Do Searching Algorithms Solve?](#what-problem-do-searching-algorithms-solve)
  - [When to Use Different Search Algorithms](#when-to-use-different-search-algorithms)
  - [When NOT to Use Certain Search Algorithms](#when-not-to-use-certain-search-algorithms)
- [13.2 Conceptual Overview](#conceptual-overview)
  - [Intuitive Explanation](#intuitive-explanation)
  - [Why Searching Matters](#why-searching-matters)
  - [Search Problem Types](#search-problem-types)
- [13.3 Abstract Model & Invariants ⭐ (Mandatory)](#abstract-model-invariants-mandatory)
  - [Abstract Model](#abstract-model)
  - [Core Invariants](#core-invariants)
  - [Algorithm-Specific Invariants](#algorithm-specific-invariants)
  - [Assumptions](#assumptions)
- [13.4 Operations & Interface](#operations-interface)
  - [Behavioral Guarantees](#behavioral-guarantees)
- [13.5 Time & Space Complexity](#time-space-complexity)
  - [Time Complexity Comparison](#time-complexity-comparison)
  - [Space Complexity](#space-complexity)
  - [Detailed Analysis](#detailed-analysis)
- [13.6 Pseudocode (Language-Neutral) ⭐ (Mandatory)](#pseudocode-language-neutral-mandatory)
  ...
  - [Find Last Occurrence](#find-last-occurrence)
  - [Jump Search](#jump-search)
- [13.7 Implementation (Reference Language: C++) ⭐](#implementation-reference-language-c)
- [13.8 Correctness Argument](#correctness-argument)
...
- [13.9 Edge Cases & Failure Modes](#edge-cases-failure-modes)
  - [Empty Data Structure](#empty-data-structure)
  - [Single Element](#single-element)
  - [Target Not Present](#target-not-present)
  - [Duplicate Elements](#duplicate-elements)
  - [Unsorted Data (Binary Search)](#unsorted-data-binary-search)
  - [Integer Overflow](#integer-overflow)
  - [Common Failure Patterns](#common-failure-patterns)
- [13.10 Performance & System Considerations ⭐ (Differentiator)](#performance-system-considerations-differentiator)
  - [Cache Locality](#cache-locality)
  - [Branch Prediction](#branch-prediction)
  - [Memory Access Patterns](#memory-access-patterns)
  - [Practical Recommendations](#practical-recommendations)
- [13.11 Linear Search](#linear-search)
  - [Implementation](#implementation)
  - [Time Complexity](#time-complexity)
  - [When to Use](#when-to-use)
- [13.12 Binary Search](#binary-search)
  - [Basic Implementation](#basic-implementation)
  - [Binary Search Variations](#binary-search-variations)
  - [Time Complexity](#time-complexity)
  - [Requirements](#requirements)
- [13.13 Jump Search](#jump-search)
...
- [13.14 Exponential Search](#exponential-search)
  - [Implementation](#implementation)
  - [Time Complexity](#time-complexity)
  - [Use Cases](#use-cases)
- [13.15 Interpolation Search](#interpolation-search)
  - [Implementation](#implementation)
  - [Time Complexity](#time-complexity)
  - [When to Use](#when-to-use)
- [13.16 Ternary Search](#ternary-search)
  - [Implementation](#implementation)
  - [Time Complexity](#time-complexity)
- [13.17 Hash-Based Searching](#hash-based-searching)
  - [Implementation](#implementation)
  - [Time Complexity](#time-complexity)
- [13.18 Tree-Based Searching](#tree-based-searching)
  - [Binary Search Tree Search](#binary-search-tree-search)
  - [Time Complexity](#time-complexity)
- [13.19 String Searching](#string-searching)
  - [Naive String Search](#naive-string-search)
  - [Boyer-Moore (Simplified)](#boyer-moore-simplified)
- [13.20 Comparison of Search Algorithms](#comparison-of-search-algorithms)
- [13.21 Key Takeaways](#key-takeaways)
- [13.22 Choosing the Right Search Algorithm](#choosing-the-right-search-algorithm)
  - [Decision Framework](#decision-framework)
  - [Real-World Recommendations](#real-world-recommendations)
  - [Decision Tree](#decision-tree)
- [13.23 Exercises](#exercises)
- [13.24 Summary](#summary)
